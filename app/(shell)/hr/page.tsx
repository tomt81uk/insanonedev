...
export default function HRMenuPage() {
  ...
  const CARDS: Card[] = useMemo(
    () => [
      {
        title: "People",
        desc: "Employees, profiles, contacts, IDs",
        href: "/workers",
        icon: Users,
      },
      {
        title: "Positions",
        desc: "Jobs, grades, posts & structure",
        href: "/app/hr/positions",
        icon: Briefcase,
      },
      {
        title: "Leave & Absence",
        desc: "Annual leave, sickness, balances",
        href: "/app/hr/leave",
        icon: CalendarCheck2,
      },
      {
        title: "Documents",
        desc: "Contracts, policies, attachments",
        href: "/app/hr/documents",
        icon: FileText,
      },
      {
        title: "Compliance",
        desc: "Right-to-work, expiries, training",
        href: "/app/hr/compliance",
        icon: ShieldCheck,
      },
      {
        title: "Visas & IDs",
        desc: "Residency, work permits, EID",
        href: "/app/hr/visas",
        icon: IdCard,
      },
      {
        title: "Bank Changes",
        desc: "IBAN updates & approvals",
        href: "/app/hr/bank-changes",
        icon: Banknote,
      },
      {
        title: "Data Quality",
        desc: "Validation issues and fixes",
        href: "/app/hr/data-quality",
        icon: Bug,
      },
      {
        title: "Background Checks",
        desc: "Clearance & onboarding evidence",
        href: "/app/hr/background-checks",
        icon: ClipboardCheck,
      },
      {
        title: "Probation",
        desc: "Reviews & outcomes",
        href: "/app/hr/probation",
        icon: Rocket,
      },
      {
        title: "Leavers",
        desc: "Offboarding & exit tasks",
        href: "/app/hr/leavers",
        icon: LogOut,
      },
      {
        title: "Reports",
        desc: "Headcount, leave, compliance",
        href: "/app/hr/reports",
        icon: BarChart3,
      },
      {
        title: "Settings",
        desc: "Grades, work patterns, lookups",
    ...
    <section className="mx-auto max-w-7xl px-4 py-8 md:py-12">
      ...
      <header className="mb-6 md:mb-8 flex flex-wrap items-end justify-between gap-4">
        <div className="space-y-1.5">
          ...
          <p className="text-[var(--muted)]">Pick an area to manage.</p>
        </div>
