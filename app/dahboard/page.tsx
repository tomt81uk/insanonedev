...
export default function DashboardPage() {
  ...
  return (
    // no local header/footer; layout provides them
    <main
      id="main"
      tabIndex={-1}
      className="mx-auto max-w-7xl px-4 pt-20 md:pt-24 pb-12 text-slate-900"
      style={{ direction: "ltr", overflowX: "clip" }} // keep scrollbar on the right; your layout flips content for ar
    >
      {/* Heading */}
